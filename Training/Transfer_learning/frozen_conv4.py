...
class PlotMetrics(Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        save_path = f'figures/{self.label_column}_{self.learning_rate}_current_epoch.png'
...
def train_model(learning_rate, label_column, epochs):
    ...
    plot_metrics.save_to_csv(f'tf_loss/{label_column}_{learning_rate}_metrics.csv')
